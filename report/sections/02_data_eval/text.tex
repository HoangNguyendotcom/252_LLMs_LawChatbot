...
\begin{itemize}
  \item \textbf{Độ dài câu hỏi trung bình:} 31.9 từ. Các câu hỏi thường ngắn gọn, súc tích nhưng yêu cầu
độ chính xác cao về mặt thông tin, đòi hỏi hệ thống phải tìm đúng "keyword" chuyên
ngành thay vì chỉ so khớp từ vựng thông thường.
  \item \textbf{Độ dài câu trả lời trung bình:} 360.6 từ. Độ dài này phản ánh mức độ chi tiết và thông tin
phong phú cần được hệ thống RAG tổng hợp và xử lý để đưa ra câu trả lời thỏa đáng.
\end{itemize}
...
\end{itemize}
Việc phân tích kỹ lưỡng đặc điểm này giúp định hướng việc lựa chọn mô hình Vietnamese-
sbert (tối ưu cho tiếng Việt), chiến lược Hybrid Search (kết hợp từ khóa và ngữ nghĩa) và thiết kế Prompt phù hợp trong các bước tiếp theo.
...
\]
\textbf{Ý nghĩa:} Chỉ số này phản ánh mức độ tương đồng ngữ nghĩa tổng thể giữa hai văn bản. Giá trị
cao cho thấy nội dung trả lời gần về mặt ý nghĩa.
...
\]
\textbf{Ý nghĩa:} Cả hai chỉ số đều phản ánh mức độ chia sẻ từ vựng trực tiếp. Token Overlap đặc biệt
hữu ích để đánh giá mức độ bao phủ các từ khóa quan trọng của câu trả lời chuẩn.
...
\[
  ...
  \end{cases}
\]
\textbf{Ý nghĩa:} BLEU đánh giá độ chính xác của các cụm từ (n-gram) trong câu trả lời sinh ra. Hệ số
phạt ngắn gọn (BP) đảm bảo rằng câu trả lời quá ngắn không bị đánh giá cao một cách giả tạo.
...
\]
\textbf{Ý nghĩa:} ROUGE-L tập trung vào việc đánh giá sự tương đồng về cấu trúc và trình tự thông
tin. Giá trị cao cho thấy câu trả lời sinh ra có bố cục logic và trình tự nội dung gần với câu trả
lời chuẩn.