...
Đo lường độ tương đồng giữa các vector nhúng của câu trả lời sinh ra và câu trả lời chuẩn. Cho các vector nhúng $v_{\hat{y}}$ và $v_y$:
\[
...
Đo lường độ chính xác n-gram của câu trả lời sinh ra so với câu trả lời tham chiếu:
\[
...
Đo lường độ dài của chuỗi con chung dài nhất (LCS) giữa $\hat{y}$ và $y$:
\[
