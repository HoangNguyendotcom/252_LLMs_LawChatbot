...
\begin{tabular}{lc}
  ...
  \midrule
  \texttt{BAAI/bge-m3}                        & 0.876006 \\
  \texttt{keepitreal/vietnamese-sbert}         & 0.858670 \\
...
Mô hình \texttt{Qwen1.5-1.8B} tồn tại nhiều hạn chế trong việc sinh văn bản tiếng Việt: các câu trả lời thường thiếu tự nhiên, sai ngữ pháp, hoặc xuất hiện hiện tượng pha trộn giữa tiếng Việt và tiếng Trung. Do đó, quyết định thay thế bằng \texttt{Qwen3-1.7B} -- phiên bản được huấn luyện với tập dữ liệu đa ngôn ngữ phong phú hơn và hỗ trợ tiếng Việt tốt hơn.
...
\begin{itemize}
  ...
  \item \textbf{Lexical Retrieval (BM25):} Ưu tiên sự tương đồng về \textbf{từ khóa}.
\end{itemize}
...
Sau đó, bước \textbf{Rerank} dùng mô hình Cross-Encoder (\texttt{BAAI/bge-reranker-large}) để tinh chỉnh thứ hạng, loại bỏ các tài liệu nhiễu trước khi đưa vào LLM.
